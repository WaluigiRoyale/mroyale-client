...
File.prototype.new = function(){
    app.load({
        ...
        mode:"royale",
        resource:[
            { id: "map", src: ASSETS_URL + "img/game/smb_map.png" },
            { id: "obj", src: ASSETS_URL + "img/game/smb_obj.png" }
        ],
        world:[{
            id:0,
            name:"New Level",
...
_0x1ad34e.prototype.show = function(_0x2db366) {
    this.element.innerHTML = "<img src='" + ASSETS_URL + "img/home/warn.png' class='warn-ico'/> " + _0x2db366;
