var ASSETS_URL = "https://raw.githubusercontent.com/mroyale/assets/master/";
{
    ...
    (function($) {
        var pagify = {
            ...
            updateNavigation: function(id) {
                ...
                $("#" + pgId + " > .page[data-page=\"" + (this.currentPage[id] + 1) + '"]').addClass("current");
            },
