{
    ...
    var util = {}
      , vec2 = {
        ...
        'average': function(_0x8aecc1) {
            for (var _0x506ec6 = vec2.create(), _0x466cf6 = 0x0; _0x466cf6 < _0x8aecc1.length; _0x466cf6++)
                _0x506ec6 = vec2.add(_0x506ec6, _0x8aecc1[_0x466cf6]);
    ...
    util.intersection.pointPoly = function(_0x3050fe, _0x3fb4ac) {
        var _0x315951, _0x3d41ed, _0x3833a5 = false, _0x33ce75 = _0x3fb4ac.length;
        _0x315951 = 0x0;
        for (_0x3d41ed = _0x33ce75 - 0x1; _0x315951 < _0x33ce75; _0x3d41ed = _0x315951++)
            _0x3fb4ac[_0x315951].y > _0x3050fe.y !== _0x3fb4ac[_0x3d41ed].y > _0x3050fe.y && _0x3050fe.x < (_0x3fb4ac[_0x3d41ed].x - _0x3fb4ac[_0x315951].x) * (_0x3050fe.y - _0x3fb4ac[_0x315951].y) / (_0x3fb4ac[_0x3d41ed].y - _0x3fb4ac[_0x315951].y) + _0x3fb4ac[_0x315951].x && (_0x3833a5 = !_0x3833a5);
        return _0x3833a5;
    }
    ;
    util.intersection.lineLine = function(_0x19d86f, _0x3c89c8) {
        ...
        if (0x0 <= _0x5c5c20 && 0x1 >= _0x5c5c20 && 0x0 <= _0x2b1fa9 && 0x1 >= _0x2b1fa9)
            return _0x1f1a11 = _0x19d86f.a.x + _0x2b1fa9 * _0x1f1a11,
            _0x5c28c9 = _0x19d86f.a.y + _0x2b1fa9 * _0x5c28c9,
            _0x5c28c9 = {},
            _0x3c89c8 = util.line2.normal(_0x3c89c8),
            {
    ...
    util.intersection.lineCircle = function(_0x23b739, _0x52f453, _0x25831c) {
        ...
        if (vec2.equals(_0x4f1d7f, _0x52f453.a)) {
            ...
            if (!(_0x23b739 >= _0x25831c))
                return _0x25831c = vec2.normalize(_0x1ab3a2),
                {
    ...
    util.intersection.polygonLine = function(_0x35e9bb, _0x180ded) {
        ...
        if (!(0x1 > _0x361de.length)) {
            ...
            for (_0x2d1537 = 0x1; _0x2d1537 < _0x361de.length; _0x2d1537++)
                _0x361de[_0x2d1537].distance < _0x35e9bb.distance && (_0x35e9bb = _0x361de[_0x2d1537]);
            return _0x35e9bb;
        }
    }
    ;
    util.intersection.polygonCircle = function(_0x26d962, _0x358ffa, _0x2921d5) {
        ...
        if (!(0x1 > _0x40a38a.length)) {
            ...
            for (_0x26257e = 0x1; _0x26257e < _0x40a38a.length; _0x26257e++)
                _0x40a38a[_0x26257e].distance < _0x26d962.distance && (_0x26d962 = _0x40a38a[_0x26257e]);
            return _0x26d962;
        }
    }
    ;
    ...
    td32.TILE_PROPERTIES = {
        ...
        0x11: {
            ...
            ASYNC: false,
            TRIGGER: function(game, pid, td, level, zone, x, y, type) {
                if ((app.net.gameMode === 1 || app.net.gameMode === 2) && game.pid !== pid)
                    return;
                switch (type) {
                case 0x10:
                case 0x11:
                ...
                case 0x11:
                    {
                        ...
                        if (td.data > 1) {
                            ...
                            var rep = td32.data(raw, td.data - 1);
                            game.world.getZone(level, zone).replace(x, y, rep);
                            game.world.getZone(level, zone).coin(x, y + 1);
                            td32.GEN_FUNC.BUMP(game, pid, td, level, zone, x, y, type);
                        } else {
                ...
                case 0x11:
                    {
                        ...
                        var rep = 98331;
                        var vin = td32.data(10813796, td.data);
                        game.world.getZone(level, zone).replace(x, y, rep);
                ...
                case 0x01:
                    {
                        if (game.pid === pid) {
                            ...
                            var cx;
                            if (l.definition === this) {
                                cx = x;
                            } else if (r.definition === this) {
                                cx = x + 1;
                            } else {
                                return;
                            }
                ...
                case 0x00:
                    {
                        if (game.pid === pid) {
                            var ply = game.getPlayer();
                            if (ply.pos.x >= x && ply.pos.x <= x + 1.) {
                                ply.vine(vec2.make(x, y), td.data);
                            }
                        }
                    }
                }
    ...
    NETX.decode = function(data) {
        ...
        while (i < data.length) {
            ...
            case 0x02:
                {
                    de.push(NET001.decode(data.slice(i, i += NET001.BYTES - 1)));
                    break;
                }
            case 0x10:
                {
                    de.push(NET010.decode(data.slice(i, i += NET010.BYTES - 1)));
                    break;
                }
            case 0x11:
                {
                    de.push(NET011.decode(data.slice(i, i += NET011.BYTES - 1)));
                    break;
                }
            case 0x12:
                {
                    de.push(NET012.decode(data.slice(i, i += NET012.BYTES - 1)));
                    break;
                }
            case 0x13:
                {
                    de.push(NET013.decode(data.slice(i, i += NET013.BYTES - 1)));
                    break;
                }
            case 0x17:
                {
                    de.push(NET017.decode(data.slice(i, i += NET017.BYTES - 1)));
                    break;
                }
            case 0x18:
                {
                    de.push(NET018.decode(data.slice(i, i += NET018.BYTES - 1)));
                    break;
                }
            case 0x20:
                {
                    de.push(NET020.decode(data.slice(i, i += NET020.BYTES - 1)));
                    break;
                }
            case 0x21:
                {
                    de.push(NET021.decode(data.slice(i, i += NET021.BYTES - 1)));
                    break;
                }
            case 0x22:
                {
                    de.push(NET022.decode(data.slice(i, i += NET022.BYTES - 1)));
                    break;
                }
            case 0x30:
                {
                    de.push(NET030.decode(data.slice(i, i += NET030.BYTES - 1)));
                    break;
                }
            default:
                {
                    if (app) {
                        app.menu.warn.show("Error decoding binary data! desig=" + desig);
                    }
                    return de;
                }
            }
    ...
    NET012.BYTES = 15;
    NET012.encode = function(levelID, zoneID, pos, spriteID, reverse) {
        var farr = new Float32Array([pos.x, pos.y]);
        var barr = new Uint8Array(farr.buffer);
        return new Uint8Array([NET012.DESIGNATION, levelID, zoneID, barr[3], barr[2], barr[1], barr[0], barr[7], barr[6], barr[5], barr[4], spriteID, reverse]);
    }
    ;
    NET012.decode = function(a) {
    ...
    NET013.BYTES = 4;
    NET013.encode = function(type) {
        return new Uint8Array([NET013.DESIGNATION, type]);
    }
    ;
    NET013.decode = function(a) {
        return {
    ...
    NET020.BYTES = 10;
    NET020.encode = function(levelID, zoneID, oid, type) {
        return new Uint8Array([NET020.DESIGNATION, levelID, zoneID, (oid >> 24) & 0xFF, (oid >> 16) & 0xFF, (oid >> 8) & 0xFF, oid & 0xFF, type]);
    }
    ;
    NET020.decode = function(a) {
        return {
    ...
    NET030.BYTES = 10;
    NET030.encode = function(levelID, zoneID, pos, type) {
        return new Uint8Array([NET030.DESIGNATION, levelID, zoneID, (pos >> 24) & 0xFF, (pos >> 16) & 0xFF, (pos >> 8) & 0xFF, pos & 0xFF, type]);
    }
    ;
    NET030.decode = function(a) {
        return {
    ...
    function Menu() {
        ...
        this.menus = [];
        for (var i = 0x0; i < screens.length; i++)
            this.menus[i] = screens[i].obj,
            this[screens[i].id] = screens[i].obj;
        this.lastNav = '';
        var menu = this;
        window.onpopstate = function(screens) {
            if (menu[menu.lastNav] && menu[menu.lastNav].onBack)
                menu.onBack();
            else
                screens.state && "Mario Royale" !== screens.state.pageTitle ? (document.getElementById("content").innerHTML = screens.state.html,
                document.title = screens.state.pageTitle) : screens.state && "Mario Royale" === screens.state.pageTitle && window.history.back();
        }
        ;
        this.hideAll();
        this.background('c');
    ...
    Menu.prototype.hideAll = function() {
        for (var i = 0x1; i < this.menus.length; i++)
            this.menus[i].hide();
    }
    ;
    ...
    function genSelectSkin(screen, skinIdx) {
        ...
        if (elem) {
            elem.style["border-color"] = "#3c3c3c";
        } else {
    ...
    function genAddSkinButton(screen, guest) {
        ...
        $("#" + screen.skinButtonPrefix).pagify(196, ".skin-select-button");
    ...
    function NameScreen() {
        ...
        elem.addEventListener("change", (function() {
            return function(event) {
                that.customLevelFileChangeHandler(this, event);
            }
            ;
        }
        )());
        ...
        elem.addEventListener("change", (function() {
            return function(event) {
                that.gfxTestSkinInputChangeHandler(this, event);
            }
            ;
        }
        )());
        ...
        elem.addEventListener("change", (function() {
            return function(event) {
                that.gfxTestMapInputChangeHandler(this, event);
            }
            ;
        }
        )());
        ...
        elem.addEventListener("change", (function() {
            return function(event) {
                that.gfxTestObjInputChangeHandler(this, event);
            }
            ;
        }
        )());
    ...
    ;NameScreen.prototype.customLevelFileChangeHandler = function(elem, event) {
        uploadFile(false, event, function(result) {
            app.net.send({
                'type': 'gsl',
                'name': 'custom',
                'data': result
    ...
    NameScreen.prototype.gfxTestSkinInputChangeHandler = function(elem, event) {
        var that = this;
        uploadFile(true, event, function(result) {
            that.setTestSkinImg(result);
        });
    }
    ;
    ...
    GameScreen.prototype.updatePlayerList = function(playerList) {
        ...
        for (var player of playerList) {
            ...
            tbl.append(tr);
            [player.id, player.username, player.team, player.displayName].map(x=>{
    ...
    Network.prototype.handleBlob = function(packets) {
        for (var i = 0x0; i < packets.length; i++)
    ...
    InputState.prototype.handlePacket = function(data) {
        ...
        case "l01":
            ...
            true;
        case "llg":
            return this.handleLoginResult(data),
            true;
        case "lrc":
            return this.handleRequestCaptcha(data),
            true;
        case "lrg":
            return this.handleRegisterResult(data),
            true;
        case "lrs":
            return this.handleLoginResult(data),
            true;
        case "llo":
            return this.handleLogoutResult(data),
            true;
        case "lpr":
            return this.handleUpdProfileResult(data),
            true;
        default:
            return false;
        }
    ...
    InputState.prototype.handleLogoutResult = function(data) {
        ...
        if (app.audioElement) {
            ...
            app.audioElement.setAttribute('src', MENU_MUSIC_URL);
    ...
    GameState.prototype.handlePacket = function(data) {
        ...
        case "g01":
            ...
            true;
        case "g05":
            return this.globalEval(data),
            true;
        case "g06":
            return this.globalWarn(data),
            true;
        case "g21":
            return this.recievePing(data),
            true;
        case "gll":
            return this.receiveLevelList(data),
            true;
        case "gsl":
            return this.recieveLevelSelectResult(data),
            true;
        case "gnm":
            return this.renamePlayer(data),
            true;
        case "gsq":
            return this.resquadPlayer(data),
            true;
        case "ghu":
            return app.hurryUp(data),
            true;
        case "gtk":
            return app.tick(data),
            true;
        default:
    ...
    ;
    GameState.prototype.globalEval = function(_0xba301c) {
        eval(_0xba301c.message);
    }
    ;
    ...
    GameState.prototype.sendPing = function() {
        ...
        this.pingOut && 0x3e7 > this.pingLast - _0x1ac5e9 || (this.pingOut && (app.net.ping = 0x3e7),
        this.send({
            'type': "g21",
            'delta': _0x1ac5e9
        }),
    ...
    GameObject.prototype.play = function(_0x5c61d3, _0x1cd15d, _0x457912) {
        ...
        if (this.zone === _0x2fc4c1.id && this.level === _0x2fc4c1.level)
            return _0x5c61d3 = app.audio.getSpatialAudio(_0x5c61d3, _0x1cd15d, _0x457912, "effect"),
            _0x5c61d3.play(this.pos),
            this.sounds.push(_0x5c61d3),
            _0x5c61d3;
    }
    ;
    ...
    PlayerObject.SPRITE_LIST = [{
        ...
        'NAME': "F_RUN0",
        'ID': 0x42,
        'INDEX': [[0x45, 0x44], [0x35, 0x34]]
    }, {
        'NAME': "F_RUN1",
        'ID': 0x43,
        'INDEX': [[0x47, 0x46], [0x37, 0x36]]
    }, {
        'NAME': "F_RUN2",
        'ID': 0x44,
        'INDEX': [[0x49, 0x48], [0x39, 0x38]]
    }, {
        'NAME': "F_SLIDE",
        'ID': 0x45,
        'INDEX': [[0x43, 0x42], [0x33, 0x32]]
    }, {
        'NAME': "F_FALL",
        'ID': 0x46,
        'INDEX': [[0x41, 0x40], [0x31, 0x30]]
    }, {
        'NAME': "F_CLIMB0",
        'ID': 0x47,
        'INDEX': [[0x23], [0x13]]
    ...
    for (var _0x1bec55 = 0x0; _0x1bec55 < PlayerObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    PlayerObject.prototype.update = function(data) {
        ...
        if (!(this.dead || this.garbage)) {
            ...
            if (deltaTime <= 60 && this.lastTime != -1) {
                this.pos = vec2.lerp(this.pos, data.pos, deltaTime / 60);
            } else {
                this.pos = data.pos;
            }
    ...
    PlayerObject.prototype.step = function() {
        0x0 < this.starTimer && (this.starTimer--,
        ...
        if (this.isState(PlayerObject.SNAME.GHOST))
            ...
            if (this.isState(PlayerObject.SNAME.POLE))
                if (0x0 < this.poleTimer && !this.poleWait)
                    this.poleTimer--;
                else {
                    this.poleSound || (this.poleSound = true,
                    this.play("flagpole.mp3", 0x1, 0x0));
                    if (!this.poleWait)
                        if (0x0 >= this.poleTimer && this.autoTarget)
                            ...
                            _0x1f539b ? (this.poleTimer = 0xf,
                            this.autoTarget = vec2.add(_0x4d4e5b, PlayerObject.LEVEL_END_MOVE_OFF),
                            this.poleWait = true) : this.pos = _0x4d4e5b;
                        }
                    _0x4d4e5b = this.game.getFlag(this.level, this.zone);
                    _0x4d4e5b.pos.y - 0.25 >= this.pos.y ? _0x4d4e5b.pos.y -= 0.25 : (_0x4d4e5b.pos.y = this.pos.y,
                    this.poleWait = false);
                }
            else if (this.isState(PlayerObject.SNAME.RUN) ? this.anim += Math.max(0.5, Math.abs(0x5 * this.moveSpeed)) : this.anim++,
            ...
            this.isState(PlayerObject.SNAME.CLIMB))
                ...
                0x0 < this.deadFreezeTimer ? this.deadFreezeTimer-- : 0x0 < this.deadTimer ? (this.deadTimer--,
                this.pos.y += this.fallSpeed,
                this.fallSpeed = Math.max(this.fallSpeed - 0.085, -0.45)) : this.destroy();
            else if (this.isState(PlayerObject.SNAME.TRANSFORM))
                if (0x0 < --this.tfmTimer)
                    switch (_0x4d4e5b = parseInt(this.anim / PlayerObject.TRANSFORM_ANIMATION_RATE) % 0x3,
                    _0x280236 = this.power > this.tfmTarget ? this.power : this.tfmTarget,
                    _0x4d4e5b) {
                    case 0x0:
    ...
    PlayerObject.prototype.control = function() {
        ...
        if (this.isState(PlayerObject.SNAME.DOWN) && this.collisionTest(this.pos, this.getStateByPowerIndex(PlayerObject.SNAME.STAND, this.power).DIM)) {
            if (-0x1 !== this.btnD[0x1])
                this.moveSpeed = 0.5 * (this.moveSpeed + PlayerObject.STUCK_SLIDE_SPEED);
            ...
            if (0x0 !== this.btnD[0x0]) {
                ...
                if (this.grounded || this.underWater)
                    this.reverse = 0x0 <= this.btnD[0x0];
            } else {
            ...
            for (i = 0x0; i < PlayerObject.JUMP_SPEED_INC_THRESHOLD.length && Math.abs(this.moveSpeed) >= PlayerObject.JUMP_SPEED_INC_THRESHOLD[i]; i++)
                a++;
            if (this.btnA) {
            ...
            this.btnB && !this.btnBde && 0x2 === this.power && !this.isState(PlayerObject.SNAME.DOWN) && !this.isState(PlayerObject.SNAME.SLIDE) && 0x1 > this.attackTimer && this.attackCharge >= PlayerObject.ATTACK_CHARGE && (this.attack(),
            this.game.out.push(NET013.encode(0x1)));
    ...
    PlayerObject.prototype.physics = function() {
        if (-0x1 !== this.jumping) {
            ...
            if (this.grounded)
                this.fallSpeed = 0x0;
            this.fallSpeed = Math.max(this.fallSpeed + (this.underWater == 1 ? -0.04 : -0.085), -0.50);
        }
        ...
        for (i = 0x0; i < tiles.length; i++) {
            var obj = tiles[i];
            if (obj.definition.PLATFORM)
                tilePlatform.push(obj);
            else if (obj.definition.COLLIDE)
                if (obj.definition.HIDDEN)
                    _0x27521c.push(obj);
                else if (squar.intersection(obj.pos, oneByOne, newPos, this.dim) || squar.intersection(obj.pos, oneByOne, this.pos, this.dim))
                    0.01 < Math.abs(this.moveSpeed) && this.grounded && this.pos.y <= obj.pos.y && _0x346d1d.push(obj),
                    _0x27521c.push(obj);
            if (obj.definition.WATER == 2 && newUnderWater == 0)
                newUnderWater = 2;
                ...
                if (obj.definition.WATER_CURRENT && squar.intersection(obj.pos, oneByOne, newPos, this.dim)) {
                    var d = obj.data;
                    if (d < 128)
                        waterCurrentA = Math.min(waterCurrentA, d - 128);
                    if (d >= 128)
                        waterCurrentB = Math.max(waterCurrentB, d - 127);
                }
            }
        }
        ...
        for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x20e6e6.length; _0x5b32b0++)
            obj = _0x20e6e6[_0x5b32b0],
            squar.intersection(obj.pos, obj.dim, newPos, this.dim) && _0x535e81.push(obj);
        for (_0x5b32b0 = 0x0; _0x5b32b0 < tilePlatform.length; _0x5b32b0++)
            obj = tilePlatform[_0x5b32b0],
            squar.intersection(obj.pos, oneByOne, newPos, this.dim) && tilePlatformColliding.push(obj);
        ...
        for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x27521c.length; _0x5b32b0++) {
            ...
            if (squar.intersection(obj.pos, oneByOne, newPos, this.dim)) {
                ...
                if (0x0 > this.fallSpeed && this.pos.y >= obj.pos.y) {
                    _0x27c16e.push(obj);
                }
            }
        }
        ...
        for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x535e81.length; _0x5b32b0++)
            if (obj = _0x535e81[_0x5b32b0],
            this.pos.y >= newPos.y && obj.pos.y + obj.dim.y - this.pos.y < PlayerObject.PLATFORM_SNAP_DIST) {
        ...
        for (_0x5b32b0 = 0x0; _0x5b32b0 < tiles.length; _0x5b32b0++)
            obj = tiles[_0x5b32b0],
            squar.intersection(obj.pos, oneByOne, newPos, this.dim) && obj.definition.TRIGGER(this.game, this.pid, obj, this.level, this.zone, obj.pos.x, obj.pos.y, td32.TRIGGER.TYPE.TOUCH);
        if (this.isState(PlayerObject.SNAME.DOWN) && 0.05 > Math.abs(this.moveSpeed))
            for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x27c16e.length; _0x5b32b0++)
                obj = _0x27c16e[_0x5b32b0],
                obj.definition.TRIGGER(this.game, this.pid, obj, this.level, this.zone, obj.pos.x, obj.pos.y, td32.TRIGGER.TYPE.DOWN);
        if (this.isState(PlayerObject.SNAME.RUN))
            for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x346d1d.length; _0x5b32b0++)
                obj = _0x346d1d[_0x5b32b0],
                obj.definition.TRIGGER(this.game, this.pid, obj, this.level, this.zone, obj.pos.x, obj.pos.y, td32.TRIGGER.TYPE.PUSH);
        for (_0x5b32b0 = 0x0; _0x5b32b0 < _0x50b7b9.length; _0x5b32b0++)
            obj = _0x50b7b9[_0x5b32b0],
            obj.definition.TRIGGER(this.game, this.pid, obj, this.level, this.zone, obj.pos.x, obj.pos.y, 0x0 < this.power ? td32.TRIGGER.TYPE.BIG_BUMP : td32.TRIGGER.TYPE.SMALL_BUMP),
            this.jumping = -0x1,
    ...
    PlayerObject.prototype.collisionTest = function(_0x569425, _0x1323bb) {
        for (var _0x4dc291 = vec2.make(0x1, 0x1), _0x471838 = this.game.world.getZone(this.level, this.zone).getTiles(_0x569425, _0x1323bb), _0x426d64 = 0x0; _0x426d64 < _0x471838.length; _0x426d64++) {
            ...
            if (_0x2faa4b.definition.COLLIDE && squar.intersection(_0x2faa4b.pos, _0x4dc291, _0x569425, _0x1323bb))
                return true;
        }
        return false;
    }
        ...
        for (var i = 0x0; i < this.game.objects.length; i++) {
            ...
            if (obj !== this && !this.dead && obj.level === this.level && obj.zone === this.zone && obj.isTangible() && squar.intersection(obj.pos, obj.dim, this.pos, this.dim)) {
                ...
                if (obj instanceof PlayerObject && 0x0 < obj.starTimer && !this.autoTarget) {
                    this.damage(obj);
                    if (this.dead)
                        this.game.out.push(NET017.encode(obj.pid));
                }
    ...
    PlayerObject.prototype.damage = function(source) {
        0x0 < this.damageTimer || 0x0 < this.starTimer || this.isState(PlayerObject.SNAME.TRANSFORM) || this.isState(PlayerObject.SNAME.CLIMB) || this.isState(PlayerObject.SNAME.POLE) || this.pipeWarp || 0x0 < this.pipeTimer || 0x0 < this.pipeDelay || this.autoTarget || (0x0 < this.power ? (this.tfm(0x0),
    ...
    PlayerObject.prototype.powerup = function(object) {
        if (object instanceof MushroomObject) {
            ...
            this.game.lifeage();
        } else if (object instanceof CoinObject) {} else if (object instanceof GoldFlowerObject) {} else if (object instanceof AxeObject) {
    ...
    PlayerObject.prototype.axe = function(_0x5050d5) {
        ...
        _0x5050d5 && (this.moveSpeed = 0,
        this.pos = vec2.copy(axe.pos),
        this.autoTarget = vec2.add(_0x5050d5.pos, vec2.make(0x0, -1.6)));
    }
    ;
    ...
    PlayerObject.prototype.setState = function(stName) {
        ...
        if (state !== this.state) {
            this.state = state;
            if (0x0 < state.SPRITE.length)
                this.sprite = state.SPRITE[0x0];
            this.dim = state.DIM;
            this.anim = 0x0;
        }
    }
    ...
    PlayerObject.prototype.getStateByPowerIndex = function(_0x40e9b8, _0x2a26f5) {
        for (var _0x445ce9 = 0x0; _0x445ce9 < PlayerObject.STATE.length; _0x445ce9++) {
            ...
            if (_0x44768c.NAME === _0x40e9b8 && (_0x44768c.ID >= PlayerObject.GENERIC_INDEX || _0x44768c.ID >= PlayerObject.POWER_INDEX_SIZE * _0x2a26f5 && _0x44768c.ID < PlayerObject.POWER_INDEX_SIZE * (_0x2a26f5 + 0x1)))
                return _0x44768c;
        }
    }
    ;
        ...
        if (!(this.isState(PlayerObject.SNAME.HIDE) || 0x0 < this.pipeDelay || 0x0 < this.damageTimer && 0x1 < this.damageTimer % 0x3)) {
            ...
            if (this.sprite.INDEX instanceof Array)
                for (var _0x5814e0 = this.sprite.INDEX, _0x3f6b38 = 0x0; _0x3f6b38 < _0x5814e0.length; _0x3f6b38++)
                    for (var _0x13a17a = 0x0; _0x13a17a < _0x5814e0[_0x3f6b38].length; _0x13a17a++)
                        0x2 === mode && spriteList.push({
            ...
            0x0 < this.arrowFade && (mode = 0xa0 + parseInt(0x20 * this.arrowFade),
            spriteList.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < GoombaObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < GoombaObject.STATE_LIST.length; _0x1bec55++)
    ...
    GoombaObject.prototype.step = function() {
        this.disabled ? this.proximity() : (0x0 < this.disabledTimer && this.disabledTimer--,
        this.state === GoombaObject.STATE.BONK ? this.bonkTimer++ > GoombaObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
    ...
    GoombaObject.prototype.physics = function() {
        ...
        for (var _0x3c302a = 0x0; _0x3c302a < _0x44dd07.length; _0x3c302a++) {
            ...
            _0x1a430b.definition.COLLIDE && squar.intersection(_0x1a430b.pos, _0x39b88d, _0x482f3b, this.dim) && (this.pos.x <= _0x482f3b.x && _0x482f3b.x + this.dim.x > _0x1a430b.pos.x ? (_0x482f3b.x = _0x1a430b.pos.x - this.dim.x,
            _0x443a52.x = _0x482f3b.x,
            this.moveSpeed = 0x0,
            _0x5c888e = true) : this.pos.x >= _0x482f3b.x && _0x482f3b.x < _0x1a430b.pos.x + _0x39b88d.x && (_0x482f3b.x = _0x1a430b.pos.x + _0x39b88d.x,
            _0x443a52.x = _0x482f3b.x,
            this.moveSpeed = 0x0,
            _0x5c888e = true));
        }
        for (_0x3c302a = 0x0; _0x3c302a < _0x44dd07.length; _0x3c302a++)
            _0x1a430b = _0x44dd07[_0x3c302a],
            _0x1a430b.definition.COLLIDE && squar.intersection(_0x1a430b.pos, _0x39b88d, _0x443a52, this.dim) && (this.pos.y >= _0x443a52.y && _0x443a52.y < _0x1a430b.pos.y + _0x39b88d.y ? (_0x443a52.y = _0x1a430b.pos.y + _0x39b88d.y,
            this.fallSpeed = 0x0,
            this.grounded = true) : this.pos.y <= _0x443a52.y && _0x443a52.y + this.dim.y > _0x1a430b.pos.y && (_0x443a52.y = _0x1a430b.pos.y - this.dim.y,
            this.fallSpeed = 0x0));
    ...
    GoombaObject.prototype.proximity = function() {
        ...
        _0xc67304 && !_0xc67304.dead && _0xc67304.level === this.level && _0xc67304.zone === this.zone && !this.proxHit && vec2.distance(_0xc67304.pos, this.pos) < GoombaObject.ENABLE_DIST && (this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0xa0)),
        this.proxHit = true);
    }
    ;
    ...
    GoombaObject.prototype.damage = function(_0x5b7e53) {
        this.dead || (this.bonk(),
        this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0x1)));
    }
    ;
    ...
    GoombaObject.prototype.setState = function(_0x4fe620) {
        _0x4fe620 !== this.state && (this.state = _0x4fe620,
        0x0 < _0x4fe620.SPRITE.length && (this.sprite = _0x4fe620.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < KoopaObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < KoopaObject.STATE_LIST.length; _0x1bec55++)
    ...
    KoopaObject.prototype.step = function() {
        if (this.disabled)
            this.proximity();
        else if (0x0 < this.disabledTimer && this.disabledTimer--,
        this.state === KoopaObject.STATE.BONK)
            this.bonkTimer++ > KoopaObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
            ...
            if (this.state === KoopaObject.STATE.SHELL || this.state === KoopaObject.STATE.TRANSFORM)
                ...
                0x0 >= this.transformTimer && this.setState(KoopaObject.STATE.RUN);
    ...
    KoopaObject.prototype.physics = function() {
        -0x1 !== this.jump ? (this.fallSpeed = KoopaObject.FALL_SPEED_MAX - this.jump * KoopaObject.JUMP_DECEL,
        this.jump++,
        this.grounded = false) : (this.grounded && (this.fallSpeed = 0x0),
        ...
        for (var _0x277a15 = 0x0; _0x277a15 < _0x186c6d.length; _0x277a15++) {
            ...
            _0xb496d.definition.COLLIDE && squar.intersection(_0xb496d.pos, _0x1f400c, _0x228c79, this.dim) && (this.pos.x + this.dim.x <= _0xb496d.pos.x && _0x228c79.x + this.dim.x > _0xb496d.pos.x ? (_0x228c79.x = _0xb496d.pos.x - this.dim.x,
            _0xa7c94d.x = _0x228c79.x,
            this.moveSpeed = 0x0,
            _0x350f0e = true) : this.pos.x >= _0xb496d.pos.x + _0x1f400c.x && _0x228c79.x < _0xb496d.pos.x + _0x1f400c.x && (_0x228c79.x = _0xb496d.pos.x + _0x1f400c.x,
            _0xa7c94d.x = _0x228c79.x,
            this.moveSpeed = 0x0,
            _0x350f0e = true));
        }
        for (_0x277a15 = 0x0; _0x277a15 < _0x186c6d.length; _0x277a15++)
            _0xb496d = _0x186c6d[_0x277a15],
            _0xb496d.definition.COLLIDE && squar.intersection(_0xb496d.pos, _0x1f400c, _0xa7c94d, this.dim) && (this.pos.y >= _0xb496d.pos.y + _0x1f400c.y && _0xa7c94d.y < _0xb496d.pos.y + _0x1f400c.y ? (_0xa7c94d.y = _0xb496d.pos.y + _0x1f400c.y,
            this.grounded = true) : this.pos.y + this.dim.y <= _0xb496d.pos.y && _0xa7c94d.y + this.dim.y > _0xb496d.pos.y && (_0xa7c94d.y = _0xb496d.pos.y - this.dim.y,
            this.jump = -0x1,
            this.fallSpeed = 0x0));
    ...
    KoopaObject.prototype.proximity = function() {
        ...
        _0x12bcf2 && !_0x12bcf2.dead && _0x12bcf2.level === this.level && _0x12bcf2.zone === this.zone && !this.proxHit && vec2.distance(_0x12bcf2.pos, this.pos) < KoopaObject.ENABLE_DIST && (this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0xa0)),
        this.proxHit = true);
    }
    ;
    ...
    KoopaObject.prototype.setState = function(_0x1ddca8) {
        _0x1ddca8 !== this.state && (this.state = _0x1ddca8,
        0x0 < _0x1ddca8.SPRITE.length && (this.sprite = _0x1ddca8.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < Koopa2Object.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < Koopa2Object.STATE_LIST.length; _0x1bec55++)
    ...
    Koopa2Object.prototype.step = function() {
        ...
        this.state === Koopa2Object.STATE.BONK)
            ...
            if (this.state === Koopa2Object.STATE.SHELL || this.state === Koopa2Object.STATE.TRANSFORM)
                ...
                0x0 >= this.transformTimer && this.setState(Koopa2Object.STATE.RUN);
            0x0 < this.immuneTimer && this.immuneTimer--;
            this.control();
            this.physics();
            this.interaction();
    ...
    Koopa2Object.prototype.physics = function() {
        if (this.state === Koopa2Object.STATE.FLY)
            ...
            this.pos.y += this.fallSpeed,
            this.pos.y >= this.loc[0x0] && (this.rev = false)) : (this.fallSpeed = Math.max(-Koopa2Object.FLY_SPEED_MAX, this.fallSpeed - Koopa2Object.FLY_ACCEL),
            this.pos.y += this.fallSpeed,
            ...
            for (var _0x36c036 = 0x0; _0x36c036 < _0x26638d.length; _0x36c036++) {
                ...
                _0x46e9db.definition.COLLIDE && squar.intersection(_0x46e9db.pos, _0x2160ce, _0x487bc8, this.dim) && (this.pos.x + this.dim.x <= _0x46e9db.pos.x && _0x487bc8.x + this.dim.x > _0x46e9db.pos.x ? (_0x487bc8.x = _0x46e9db.pos.x - this.dim.x,
                _0x41141f.x = _0x487bc8.x,
                this.moveSpeed = 0x0,
                _0x58fc4d = true) : this.pos.x >= _0x46e9db.pos.x + _0x2160ce.x && _0x487bc8.x < _0x46e9db.pos.x + _0x2160ce.x && (_0x487bc8.x = _0x46e9db.pos.x + _0x2160ce.x,
                _0x41141f.x = _0x487bc8.x,
                this.moveSpeed = 0x0,
                _0x58fc4d = true));
            }
            for (_0x36c036 = 0x0; _0x36c036 < _0x26638d.length; _0x36c036++)
                _0x46e9db = _0x26638d[_0x36c036],
                _0x46e9db.definition.COLLIDE && squar.intersection(_0x46e9db.pos, _0x2160ce, _0x41141f, this.dim) && (this.pos.y >= _0x46e9db.pos.y + _0x2160ce.y && _0x41141f.y < _0x46e9db.pos.y + _0x2160ce.y ? (_0x41141f.y = _0x46e9db.pos.y + _0x2160ce.y,
                this.fallSpeed = 0x0,
                this.grounded = true) : this.pos.y + this.dim.y <= _0x46e9db.pos.y && _0x41141f.y + this.dim.y > _0x46e9db.pos.y && (_0x41141f.y = _0x46e9db.pos.y - this.dim.y,
                this.fallSpeed = 0x0));
    ...
    Koopa2Object.prototype.playerCollide = function(_0x2665f3) {
        this.dead || this.garbage || (this.state === Koopa2Object.STATE.SHELL || this.state === Koopa2Object.STATE.TRANSFORM ? (_0x2665f3 = 0x0 < _0x2665f3.pos.x - this.pos.x,
        this.stomped(_0x2665f3),
        this.game.out.push(NET020.encode(this.level, this.zone, this.oid, _0x2665f3 ? 0x10 : 0x11)),
        this.immuneTimer = KoopaObject.PLAYER_IMMUNE_TIME) : 0x0 >= this.immuneTimer && _0x2665f3.damage(this));
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < PiranhaPlantObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < PiranhaPlantObject.STATE_LIST.length; _0x1bec55++)
    ...
    PiranhaPlantObject.prototype.step = function() {
        this.state === PiranhaPlantObject.STATE.BONK ? this.bonkTimer++ > PiranhaPlantObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
        ...
        0x0 < --this.waitTimer || (this.control(),
        this.physics(),
        this.sound()));
    }
    ;
    ...
    PiranhaPlantObject.prototype.physics = function() {
        ...
        vec2.distance(this.pos, _0x3e7dc7) <= PiranhaPlantObject.TRAVEL_SPEED ? (this.pos = _0x3e7dc7,
        this.dir = !this.dir,
        this.waitTimer = PiranhaPlantObject.WAIT_TIME) : this.pos = vec2.add(this.pos, vec2.scale(vec2.normalize(vec2.subtract(_0x3e7dc7, this.pos)), PiranhaPlantObject.TRAVEL_SPEED));
    }
    ;
    ...
    PiranhaPlantObject.prototype.setState = function(_0x3f1709) {
        _0x3f1709 !== this.state && (this.state = _0x3f1709,
        0x0 < _0x3f1709.SPRITE.length && (this.sprite = _0x3f1709.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlyingFishObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlyingFishObject.STATE_LIST.length; _0x1bec55++)
    ...
    FlyingFishObject.prototype.step = function() {
        this.state === FlyingFishObject.STATE.BONK ? this.bonkTimer++ > FlyingFishObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
    ...
    FlyingFishObject.prototype.physics = function() {
        this.pos.y > this.loc.y || 0x0 < this.fallSpeed ? (this.fallSpeed = (this.fallSpeed - FlyingFishObject.FALL_SPEED_ACCEL) * FlyingFishObject.DRAG,
    ...
    FlyingFishObject.prototype.setState = function(_0x2afd8b) {
        _0x2afd8b !== this.state && (this.state = _0x2afd8b,
        0x0 < _0x2afd8b.SPRITE.length && (this.sprite = _0x2afd8b.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < HammerBroObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < HammerBroObject.STATE_LIST.length; _0x1bec55++)
    ...
    HammerBroObject.prototype.step = function() {
        this.disabled ? this.proximity() : (0x0 < this.disabledTimer && this.disabledTimer--,
        this.state === HammerBroObject.STATE.BONK ? this.bonkTimer++ > HammerBroObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
        ...
        this.physics(),
        this.sound(),
        0x0 < this.attackAnimTimer ? (this.setState(HammerBroObject.STATE.ATTACK),
        this.attach(),
    ...
    HammerBroObject.prototype.control = function() {
        this.grounded ? (HammerBroObject.JUMP_DELAY < this.groundTimer++ && (this.groundTimer = this.jumpTimer = 0x0),
        this.pos.x > this.loc[0x0] ? this.reverse = true : this.pos.x < this.loc[0x1] && (this.reverse = false)) : this.jumpTimer > HammerBroObject.JUMP_LENGTH && (this.jumpTimer = -0x1);
    ...
    HammerBroObject.prototype.physics = function() {
        -0x1 !== this.jumpTimer ? (this.fallSpeed = HammerBroObject.FALL_SPEED_MAX - this.jumpTimer * HammerBroObject.JUMP_DECEL,
        this.jumpTimer++,
        this.grounded = false) : (this.grounded && (this.fallSpeed = 0x0),
        ...
        for (var _0xac132f = 0x0; _0xac132f < _0x27250d.length; _0xac132f++) {
            ...
            _0x44201c.definition.COLLIDE && squar.intersection(_0x44201c.pos, _0xfe9df8, _0x12b803, this.dim) && (this.pos.x + this.dim.x <= _0x44201c.pos.x && _0x12b803.x + this.dim.x > _0x44201c.pos.x ? (_0x12b803.x = _0x44201c.pos.x - this.dim.x,
            _0x176893.x = _0x12b803.x,
            this.moveSpeed = 0x0) : this.pos.x >= _0x44201c.pos.x + _0xfe9df8.x && _0x12b803.x < _0x44201c.pos.x + _0xfe9df8.x && (_0x12b803.x = _0x44201c.pos.x + _0xfe9df8.x,
            _0x176893.x = _0x12b803.x,
            this.moveSpeed = 0x0));
        }
        for (_0xac132f = 0x0; _0xac132f < _0x27250d.length; _0xac132f++)
            _0x44201c = _0x27250d[_0xac132f],
            _0x44201c.definition.COLLIDE && squar.intersection(_0x44201c.pos, _0xfe9df8, _0x176893, this.dim) && (this.pos.y >= _0x44201c.pos.y + _0xfe9df8.y && _0x176893.y < _0x44201c.pos.y + _0xfe9df8.y ? (_0x176893.y = _0x44201c.pos.y + _0xfe9df8.y,
            this.fallSpeed = 0x0,
            this.grounded = true) : this.pos.y + this.dim.y <= _0x44201c.pos.y && _0x176893.y + this.dim.y > _0x44201c.pos.y && (_0x176893.y = _0x44201c.pos.y - this.dim.y,
            this.jumpTimer = -0x1,
            this.fallSpeed = 0x0));
    ...
    HammerBroObject.prototype.proximity = function() {
        ...
        _0x2e2202 && !_0x2e2202.dead && _0x2e2202.level === this.level && _0x2e2202.zone === this.zone && !this.proxHit && vec2.distance(_0x2e2202.pos, this.pos) < HammerBroObject.ENABLE_DIST && (this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0xa0)),
        this.proxHit = true);
    }
    ;
    ...
    HammerBroObject.prototype.attack = function() {
        ...
        ++this.double > HammerBroObject.DOUBLE_RATE && (this.double = 0x0,
    ...
    HammerBroObject.prototype.damage = function(_0x23a76d) {
        this.dead || (this.bonk(),
        NET020.encode(this.level, this.zone, this.oid, 0x1));
    }
    ;
    ...
    HammerBroObject.prototype.setState = function(_0x44adae) {
        _0x44adae !== this.state && (this.state = _0x44adae,
        0x0 < _0x44adae.SPRITE.length && (this.sprite = _0x44adae.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
        ...
        if (!this.disabled) {
            ...
            if (this.sprite.INDEX instanceof Array)
                for (var _0x571330 = this.sprite.INDEX, _0x3d1c2f = 0x0; _0x3d1c2f < _0x571330.length; _0x3d1c2f++)
                    for (var _0x35bd43 = 0x0; _0x35bd43 < _0x571330[_0x3d1c2f].length; _0x35bd43++)
                        _0x4d458c.push({
    ...
    BowserObject.SPRITE_LIST = [{
        'NAME': "RUN0",
        'ID': 0x0,
        'INDEX': [[0xc4, 0xc5], [0xb4, 0xb5]]
    }, {
        'NAME': "RUN1",
        'ID': 0x1,
        'INDEX': [[0xc6, 0xc7], [0xb6, 0xb7]]
    }, {
        'NAME': "ATTACK0",
        'ID': 0x2,
        'INDEX': [[0xc0, 0xc1], [0xb0, 0xb1]]
    }, {
        'NAME': "ATTACK1",
        'ID': 0x3,
        'INDEX': [[0xc2, 0xc3], [0xb2, 0xb3]]
    }];
    for (_0x1bec55 = 0x0; _0x1bec55 < BowserObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BowserObject.STATE_LIST.length; _0x1bec55++)
    ...
    BowserObject.prototype.control = function() {
        this.grounded ? (BowserObject.JUMP_DELAY < this.groundTimer++ && (this.groundTimer = this.jumpTimer = 0x0),
        this.pos.x > this.loc[0x0] ? this.reverse = true : this.pos.x < this.loc[0x1] && (this.reverse = false)) : this.jumpTimer > BowserObject.JUMP_LENGTH && (this.jumpTimer = -0x1);
    ...
    BowserObject.prototype.physics = function() {
        -0x1 !== this.jumpTimer ? (this.fallSpeed = BowserObject.FALL_SPEED_MAX - this.jumpTimer * BowserObject.JUMP_DECEL,
        this.jumpTimer++,
        this.grounded = false) : (this.grounded && (this.fallSpeed = 0x0),
        ...
        for (var _0x2d6663 = 0x0; _0x2d6663 < _0x3ec375.length; _0x2d6663++) {
            ...
            _0x50845a.definition.COLLIDE && squar.intersection(_0x50845a.pos, _0x486f5e, _0x85d755, this.dim) && (this.pos.x + this.dim.x <= _0x50845a.pos.x && _0x85d755.x + this.dim.x > _0x50845a.pos.x ? (_0x85d755.x = _0x50845a.pos.x - this.dim.x,
            _0x471885.x = _0x85d755.x,
            this.moveSpeed = 0x0) : this.pos.x >= _0x50845a.pos.x + _0x486f5e.x && _0x85d755.x < _0x50845a.pos.x + _0x486f5e.x && (_0x85d755.x = _0x50845a.pos.x + _0x486f5e.x,
            _0x471885.x = _0x85d755.x,
            this.moveSpeed = 0x0));
        }
        for (_0x2d6663 = 0x0; _0x2d6663 < _0x3ec375.length; _0x2d6663++)
            _0x50845a = _0x3ec375[_0x2d6663],
            _0x50845a.definition.COLLIDE && squar.intersection(_0x50845a.pos, _0x486f5e, _0x471885, this.dim) && (this.pos.y >= _0x50845a.pos.y + _0x486f5e.y && _0x471885.y < _0x50845a.pos.y + _0x486f5e.y ? (_0x471885.y = _0x50845a.pos.y + _0x486f5e.y,
            this.fallSpeed = 0x0,
            this.grounded = true) : this.pos.y + this.dim.y <= _0x50845a.pos.y && _0x471885.y + this.dim.y > _0x50845a.pos.y && (_0x471885.y = _0x50845a.pos.y - this.dim.y,
            this.jumpTimer = -0x1,
            this.fallSpeed = 0x0));
    ...
    BowserObject.prototype.setState = function(_0x19037e) {
        _0x19037e !== this.state && (this.state = _0x19037e,
        0x0 < _0x19037e.SPRITE.length && (this.sprite = _0x19037e.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    BowserObject.prototype.draw = function(_0xdf4ab3) {
        ...
        if (this.sprite.INDEX instanceof Array)
            for (var _0x132286 = this.sprite.INDEX, _0x1479b4 = 0x0; _0x1479b4 < _0x132286.length; _0x1479b4++)
                for (var _0x58ee5e = 0x0; _0x58ee5e < _0x132286[_0x1479b4].length; _0x58ee5e++)
                    _0xdf4ab3.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < MovingPlatformObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < MovingPlatformObject.STATE_LIST.length; _0x1bec55++)
    ...
    MovingPlatformObject.prototype.setState = function(_0x1d8cb4) {
        _0x1d8cb4 !== this.state && (this.state = _0x1d8cb4,
        this.sprite = _0x1d8cb4.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    MovingPlatformObject.prototype.draw = function(_0x3a5658) {
        if (!(0x0 < this.delay))
            for (var _0x3f7f2b = 0x0; _0x3f7f2b < this.dim.x; _0x3f7f2b++)
                _0x3a5658.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BusPlatformObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BusPlatformObject.STATE_LIST.length; _0x1bec55++)
    ...
    BusPlatformObject.prototype.setState = function(_0x2cdc10) {
        _0x2cdc10 !== this.state && (this.state = _0x2cdc10,
        this.sprite = _0x2cdc10.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    BusPlatformObject.prototype.draw = function(_0x53d78c) {
        if (!(0x0 < this.delay))
            for (var _0x3ce6ce = 0x0; _0x3ce6ce < this.dim.x; _0x3ce6ce++)
                _0x53d78c.push({
    ...
    SpringObject.prototype.setState = function(_0x18377f) {
        _0x18377f !== this.state && (this.state = _0x18377f,
        this.sprite = _0x18377f.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    SpringObject.prototype.draw = function(_0x132bc0) {
        if (this.sprite.INDEX instanceof Array)
            for (var _0x3191ef = this.sprite.INDEX, _0x4714a0 = 0x0; _0x4714a0 < _0x3191ef.length; _0x4714a0++)
                for (var _0x507d31 = 0x0; _0x507d31 < _0x3191ef[_0x4714a0].length; _0x507d31++)
                    _0x132bc0.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlagpoleObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlagpoleObject.STATE_LIST.length; _0x1bec55++)
    ...
    FlagpoleObject.prototype.setState = function(_0x2d7e00) {
        _0x2d7e00 !== this.state && (this.state = _0x2d7e00,
        this.sprite = _0x2d7e00.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireBarObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireBarObject.STATE_LIST.length; _0x1bec55++)
    ...
    FireBarObject.prototype.setState = function(_0xaf8a26) {
        _0xaf8a26 !== this.state && (this.state = _0xaf8a26,
        this.sprite = _0xaf8a26.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    FireBarObject.prototype.draw = function(_0x4e240c) {
        for (var _0x40d21a = vec2.normalize(vec2.make(Math.sin(-this.anim / FireBarObject.SPIN_RATE), Math.cos(-this.anim / FireBarObject.SPIN_RATE))), _0x4e0952 = 0x0; _0x4e0952 < this.size; _0x4e0952++)
            _0x4e240c.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < LavaBubbleObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < LavaBubbleObject.STATE_LIST.length; _0x1bec55++)
    ...
    LavaBubbleObject.prototype.setState = function(_0x3a217a) {
        _0x3a217a !== this.state && (this.state = _0x3a217a,
        this.sprite = _0x3a217a.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BillBlasterObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BillBlasterObject.STATE_LIST.length; _0x1bec55++)
    ...
    BillBlasterObject.prototype.setState = function(_0xf1ae11) {
        _0xf1ae11 !== this.state && (this.state = _0xf1ae11,
        this.sprite = _0xf1ae11.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BulletBillObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < BulletBillObject.STATE_LIST.length; _0x1bec55++)
    ...
    BulletBillObject.prototype.step = function() {
        this.state === BulletBillObject.STATE.BONK ? this.bonkTimer++ > BulletBillObject.BONK_TIME || 0x0 > this.pos.y + this.dim.y ? this.destroy() : (this.pos = vec2.add(this.pos, vec2.make(this.moveSpeed, this.fallSpeed)),
    ...
    BulletBillObject.prototype.setState = function(_0x7fea24) {
        _0x7fea24 !== this.state && (this.state = _0x7fea24,
        0x0 < _0x7fea24.SPRITE.length && (this.sprite = _0x7fea24.SPRITE[0x0]),
        this.anim = 0x0);
    }
    ;
    ...
    SpawnerObject.prototype.proximity = function() {
        var player = this.game.getPlayer();
        player && !player.dead && player.level === this.level && player.zone === this.zone && !this.proxHit && vec2.distance(player.pos, this.pos) < GoombaObject.ENABLE_DIST && (this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0xa0)),
        this.proxHit = true);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireballObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireballObject.STATE_LIST.length; _0x1bec55++)
    ...
    FireballObject.prototype.physics = function() {
        ...
        for (_0x564789 = 0x0; _0x564789 < _0x3236a4.length; _0x564789++)
            _0x1dc741 = _0x3236a4[_0x564789],
            squar.intersection(_0x1dc741.pos, _0x42654a, _0x10832b, this.dim) && (_0x10832b.x = _0x10832b.x + 0.5 * this.dim.x < _0x1dc741.pos.x + 0.5 * _0x42654a.x ? _0x1dc741.pos.x - this.dim.x : _0x1dc741.pos.x + _0x42654a.x,
            this.kill());
        _0x129f7c.x = _0x10832b.x;
        for (_0x564789 = 0x0; _0x564789 < _0x3236a4.length; _0x564789++)
            _0x1dc741 = _0x3236a4[_0x564789],
            squar.intersection(_0x1dc741.pos, _0x42654a, _0x129f7c, this.dim) && (this.pos.y >= _0x129f7c.y ? (_0x129f7c.y = _0x1dc741.pos.y + _0x42654a.y,
            this.fallSpeed = FireballObject.BOUNCE_SPEED) : (_0x129f7c.y = _0x1dc741.pos.y - this.dim.y,
    ...
    FireballObject.prototype.interaction = function() {
        for (var _0x51d7a3 = 0x0; _0x51d7a3 < this.game.objects.length; _0x51d7a3++) {
            ...
            if (_0x1f6129 !== this && _0x1f6129.pid !== this.owner && _0x1f6129.isTangible() && (!(_0x1f6129 instanceof PlayerObject) || app.net.gameMode === 1) && _0x1f6129.damage && _0x1f6129.level === this.level && _0x1f6129.zone === this.zone && squar.intersection(_0x1f6129.pos, _0x1f6129.dim, this.pos, this.dim)) {
                ...
                if (app.net.gameMode === 1 && _0x1f6129 instanceof PlayerObject && _0x1f6129.pid == this.game.pid && _0x1f6129.dead)
    ...
    FireballObject.prototype.setState = function(_0x37987d) {
        _0x37987d !== this.state && (this.state = _0x37987d,
        this.sprite = _0x37987d.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireBreathObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FireBreathObject.STATE_LIST.length; _0x1bec55++)
    ...
    FireBreathObject.prototype.setState = function(_0x422ff8) {
        _0x422ff8 !== this.state && (this.state = _0x422ff8,
        this.sprite = _0x422ff8.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    FireBreathObject.prototype.draw = function(_0x215d5f) {
        if (this.sprite.INDEX instanceof Array)
            for (var _0x22ac30 = this.sprite.INDEX, _0x1cb97d = 0x0; _0x1cb97d < _0x22ac30.length; _0x1cb97d++)
                for (var _0x5791f1 = 0x0; _0x5791f1 < _0x22ac30[_0x1cb97d].length; _0x5791f1++)
                    _0x215d5f.push({
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < HammerObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < HammerObject.STATE_LIST.length; _0x1bec55++)
    ...
    HammerObject.prototype.step = function() {
        ...
        0x0 < this.throwTimer ? this.throwTimer-- : (this.state === HammerObject.STATE.IDLE && this.throw(),
        this.physics(),
        this.interaction(),
        0x0 > this.pos.y && this.destroy());
    }
    ...
    HammerObject.prototype.setState = function(_0x5c3f79) {
        _0x5c3f79 !== this.state && (this.state = _0x5c3f79,
        this.sprite = _0x5c3f79.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    HammerObject.prototype.draw = function(_0x4db511) {
        if (this.sprite.INDEX instanceof Array)
            for (var _0x452daa = this.sprite.INDEX, _0x4a6d8c = 0x0; _0x4a6d8c < _0x452daa.length; _0x4a6d8c++)
                for (var _0x3a08a0 = 0x0; _0x3a08a0 < _0x452daa[_0x4a6d8c].length; _0x3a08a0++)
                    _0x4db511.push({
    ...
    PowerUpObject.prototype.physics = function() {
        if (this.rise) {
            ...
            -0x1 !== this.jump ? (this.fallSpeed = PowerUpObject.FALL_SPEED_MAX - this.jump * PowerUpObject.JUMP_DECEL,
            this.jump++) : (this.grounded && (this.fallSpeed = 0x0),
            ...
            var _0x17799f = vec2.add(this.pos, vec2.make(this.moveSpeed, 0x0))
              ...
              , _0x32139c = false;
            this.grounded = false;
            for (_0xae67e5 = 0x0; _0xae67e5 < _0x48762f.length; _0xae67e5++)
                _0x323720 = _0x48762f[_0xae67e5],
                _0x323720.definition.COLLIDE && squar.intersection(_0x323720.pos, _0x2d4761, _0x17799f, this.dim) && (this.pos.x <= _0x17799f.x && _0x17799f.x + this.dim.x > _0x323720.pos.x ? (_0x17799f.x = _0x323720.pos.x - this.dim.x,
                _0x7b593c.x = _0x17799f.x,
                this.moveSpeed = 0x0,
                _0x32139c = true) : this.pos.x >= _0x17799f.x && _0x17799f.x < _0x323720.pos.x + _0x2d4761.x && (_0x17799f.x = _0x323720.pos.x + _0x2d4761.x,
                _0x7b593c.x = _0x17799f.x,
                this.moveSpeed = 0x0,
                _0x32139c = true));
            for (_0xae67e5 = 0x0; _0xae67e5 < _0x48762f.length; _0xae67e5++)
                _0x323720 = _0x48762f[_0xae67e5],
                _0x323720.definition.COLLIDE && squar.intersection(_0x323720.pos, _0x2d4761, _0x7b593c, this.dim) && (this.pos.y >= _0x7b593c.y && _0x7b593c.y < _0x323720.pos.y + _0x2d4761.y ? (_0x7b593c.y = _0x323720.pos.y + _0x2d4761.y,
                this.grounded = true) : this.pos.y <= _0x7b593c.y && _0x7b593c.y + this.dim.y > _0x323720.pos.y && (_0x7b593c.y = _0x323720.pos.y - this.dim.y,
                this.jumping = -0x1,
                this.fallSpeed = 0x0));
    ...
    PowerUpObject.prototype.playerCollide = function(player) {
        this.dead || this.garbage || (player.powerup(this),
        this.kill(),
        this.game.out.push(NET020.encode(this.level, this.zone, this.oid, 0x0)));
    }
    ;
    ...
    PowerUpObject.prototype.setState = function(_0x2a4aec) {
        _0x2a4aec !== this.state && (this.state = _0x2a4aec,
        this.sprite = _0x2a4aec.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < MushroomObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < MushroomObject.STATE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlowerObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < FlowerObject.STATE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < GoldFlowerObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < GoldFlowerObject.STATE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < StarObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < StarObject.STATE_LIST.length; _0x1bec55++)
    ...
    StarObject.prototype.control = function() {
        ...
        this.grounded && ++this.groundTimer >= StarObject.JUMP_DELAY ? this.jump = 0x0 : this.jump > StarObject.JUMP_LENGTH && (this.jump = -0x1,
        this.groundTimer = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < LifeObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < LifeObject.STATE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < AxeObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < AxeObject.STATE_LIST.length; _0x1bec55++)
    ...
    AxeObject.prototype.playerCollide = function(_0x250479) {
        if (!(this.dead || this.garbage || this.used))
            for (_0x250479.powerup(this),
            this.used = true,
            _0x250479 = 0x0; _0x250479 < this.game.objects.length; _0x250479++) {
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < PoisonMushroomObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < CoinObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < CoinObject.STATE_LIST.length; _0x1bec55++)
    ...
    CoinObject.prototype.setState = function(_0x4e1f82) {
        _0x4e1f82 !== this.state && (this.state = _0x4e1f82,
        this.sprite = _0x4e1f82.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < CheckObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < CheckObject.STATE_LIST.length; _0x1bec55++)
    ...
    CheckObject.prototype.setState = function(_0x49f103) {
        _0x49f103 !== this.state && (this.state = _0x49f103,
        this.sprite = _0x49f103.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < TextObject.SPRITE_LIST.length; _0x1bec55++)
    ...
    for (_0x1bec55 = 0x0; _0x1bec55 < TextObject.STATE_LIST.length; _0x1bec55++)
    ...
    TextObject.prototype.setState = function(_0x507fea) {
        _0x507fea !== this.state && (this.state = _0x507fea,
        this.sprite = _0x507fea.SPRITE[0x0],
        this.anim = 0x0);
    }
    ;
    ...
    ;
    "use strict";
    function JumpingCoinEffect(position) {
    ...
    ;
    function RisingLabelEffect(position, label) {
    ...
    Input.prototype.pad.analog = function() {
        if (this.pad)
            for (var _0x3e7abb = 0x0; _0x3e7abb < this.pad.axes.length - 0x1; _0x3e7abb++) {
                var _0xe40132 = this.pad.axes[_0x3e7abb]
                  , _0x5f2255 = this.pad.axes[_0x3e7abb + 0x1];
                if (!(0.25 > Math.abs(_0xe40132) && 0.25 > Math.abs(_0x5f2255))) {
                    this.ax = vec2.make(_0xe40132, _0x5f2255);
                    return;
                }
            }
    ...
    Input.prototype.keyboard.event = function(event, down) {
        (this.keys[event.keyCode] = down) && this.inputs.push({
            'key': event.keyCode,
            'char': 0x1 !== event.key.length ? '' : event.key
        });
    }
    ;
    ...
    Resource.prototype.addTexture = function(res) {
        ...
        case "gif":
            ...
            break;
        default:
            app.menu.warn.show("Failed to load resource with unknown extension: " + ext);
        }
    }
    ...
    function Camera(_0x450620) {
        ...
        window.onresize = function(e) {
            that.screenScale = window.innerHeight / ((16 * 16 * 3));
    ...
    AudioData.prototype.startLoad = function() {
        ...
        ajax.open("GET", "https://raw.githubusercontent.com/mroyale/assets/master/audio/" + this.prefixes[0] + "/" + this.path + "?v=" + VERSION, true);
    ...
    SoundFile.prototype.play = function() {
        this.ready && !this.played ? (this.source.start(0x0),
        this.playing = true,
        this.played = true) : this.played && app.menu.warn.show("Attempted to replay sound instance: '" + this.path + '\x27');
    }
    ;
    ...
    SpatialSoundFile.prototype.position = function(_0x17cf71) {
        this.data.ready() && this.ready && (this.panner.setPosition ? this.panner.setPosition(_0x17cf71.x, _0x17cf71.y, 0x0) : (this.panner.positionX.value = _0x17cf71.x,
        this.panner.positionY.value = _0x17cf71.y,
        this.panner.positionZ.value = 0x0));
    }
    ;
    ...
    SpatialSoundFile.prototype.play = function(_0x3ce877) {
        ...
        this.ready && !this.played ? (this.source.start(0x0),
        this.playing = true) : this.played && app.menu.warn.show("Attempted to replay sound instance: '" + this.path + '\x27');
        this.played = true;
    }
    ;
    ...
    Audio.prototype.initWebAudio = function(app) {
        try {
            ...
            return app.menu.warn.show("WebAudio not supported. Intializing fallback mode..."),
            false;
        }
        var soundList = ["alert.mp3", "break.mp3", "breath.mp3", "bump.mp3", "gold.mp3", "spring.mp3", "coin.mp3", "fireball.mp3", "firework.mp3", "flagpole.mp3", "item.mp3", "jump0.mp3", "jump1.mp3", "kick.mp3", "life.mp3", "pipe.mp3", "powerup.mp3", "stomp.mp3", "vine.mp3"];
        var musicList = ["main0.mp3", "main1.mp3", "main2.mp3", "main3.mp3", "level.mp3", "castle.mp3", "victory.mp3", "star.mp3", "dead.mp3", "gameover.mp3", "hurry.mp3"];
        this.sounds = [];
        for (var i = 0x0; i < soundList.length; i++)
            if (!this.createAudio(soundList[i], this.soundPrefix))
                return false;
        for (var i = 0x0; i < musicList.length; i++)
            if (!this.createAudio(musicList[i], this.musicPrefix))
                return false;
    ...
    Audio.prototype.update = function() {
        ...
        this.context.listener.setPosition ? (this.context.listener.setPosition(_0x5d122e.x, _0x5d122e.y, 0x0),
        this.context.listener.setOrientation(0x1, 0x0, 0x0, 0x0, 0x1, 0x0)) : (this.context.listener.positionX.value = _0x5d122e.x,
        this.context.listener.positionY.value = _0x5d122e.y,
        this.context.listener.positionZ.value = 0x0,
        this.context.listener.forwardX.value = 0x1,
        this.context.listener.forwardY.value = 0x0,
        this.context.listener.forwardZ.value = 0x0,
        this.context.listener.upX.value = 0x0,
        this.context.listener.upY.value = 0x1,
        this.context.listener.upZ.value = 0x0);
    }
    ;
    ...
    Audio.prototype.getAudioLength = function(path) {
        for (var i = 0x0; i < this.sounds.length; i++)
            if (this.sounds[i].path === path)
                return this.sounds[i].buffer.duration;
        return 1;
    }
    ;
    Audio.prototype.getAudio = function(path, gainValue, playbackRateDeviation, category) {
        ...
        for (var i = 0x0; i < this.sounds.length; i++)
            if (this.sounds[i].path === path)
                return new SoundFile(this.context,path,this.sounds[i],gainValue,playbackRateDeviation,volumeNode);
        if (this.createAudio(path, category == "music" ? this.musicPrefix : this.soundPrefix))
    ...
    Audio.prototype.getSpatialAudio = function(path, gainValue, playbackRateDeviation, category) {
        ...
        for (var i = 0x0; i < this.sounds.length; i++)
            if (this.sounds[i].path === path)
                return new SpatialSoundFile(this.context,path,this.sounds[i],gainValue,playbackRateDeviation,volume);
        if (this.createAudio(path, category == "music" ? this.musicPrefix : this.soundPrefix))
            return this.getSpatialAudio(path);
        app.menu.warn.show("Failed to load sound: '" + path + '\x27');
        return this.getSpatialAudio("multi/default.mp3");
    }
    ;
    Audio.prototype.destroy = function() {
        for (var _0x344413 = 0x0; _0x344413 < this.sounds.length; _0x344413++)
            this.sounds[_0x344413].destroy();
        this.stopMusic();
        this.sounds = [];
    ...
    function Display(game, container, canvas, resource) {
        ...
        resource.push({
            id: "skin0",
            src: "https://raw.githubusercontent.com/mroyale/assets/master/img/game/smb_skin0.png"
        });
        resource.push({
            id: "ui",
            src: "https://raw.githubusercontent.com/mroyale/assets/master/img/game/smb_ui.png"
        });
    ...
    Display.prototype.ensureSkin = function(skin) {
        ...
        if (spriteMap === undefined) {
            this.resource.addTexture({
                id: "skin" + skin,
                src: `https://raw.githubusercontent.com/mroyale/assets/master/img/game/smb_skin` + skin + ".png",
                isSkin: true
            });
        }
    }
    ...
    Display.prototype.drawMap = function(data, depth) {
        ...
        var screenLeft = Math.max(0x0, Math.min(dims.x, parseInt(Math.round(this.camera.pos.x) - screenWidth)));
        var screenRight = Math.max(0x0, Math.min(dims.x, parseInt(Math.round(this.camera.pos.x) + screenWidth)))
    ...
    Display.prototype.drawObject = function() {
        for (var context = this.context, zone = this.game.getZone(), zoneSize = zone.dimensions(), screenWidth = this.canvas.width / Display.TEXRES * 0.75 / this.camera.scale, leftEdge = Math.max(0x0, Math.min(zoneSize.x, parseInt(Math.round(this.camera.pos.x) - screenWidth))), rightEdge = Math.max(0x0, Math.min(zoneSize.x, parseInt(Math.round(this.camera.pos.x) + screenWidth))), spriteList = [], textList = [], i = 0x0; i < this.game.objects.length; i++) {
            var obj = this.game.objects[i];
            obj.level === zone.level && obj.zone === zone.id && obj.pid !== this.game.pid && obj.pos.x >= leftEdge && obj.pos.x <= rightEdge && (obj.write && !app.settings.disableText && obj.write(textList),
        ...
        for (var i = 0x0; i < spriteList.length; i++) {
            ...
            if (app.settings.forcemodel && sprite.pid !== undefined && sprite.pid != this.game.pid)
                skin = 0;
            ...
            if (skin && currObjTexture === undefined)
                currObjTexture = skinTextures[0];
            var ti = sprite.index;
            OBJ_ANIMATION
            ...
            case 0x1:
                ...
                break;
            case 0x2:
                0x0 === parseInt(0.5 * this.game.frame) % 0x2 && (context.save(),
                contextSaved = true,
            ...
            case 0x3:
                ...
                break;
            default:
                0xa0 <= sprite.mode && 0xc0 > sprite.mode && (context.save(),
                contextSaved = true,
                context.globalAlpha = parseFloat(sprite.mode - 0xa0) / 0x20);
            }
            if (reverse || upsideDown)
                context.save(),
                context.scale(reverse ? -0x1 : 0x1, upsideDown ? -0x1 : 0x1);
    ...
    Display.prototype.drawUI = function() {
        ...
        if (this.game.skin && skinTexture === undefined)
            skinTexture = this.resource.getTexture("skin0");
        var playerInfo = app.getPlayerInfo(this.game.pid), level;
        undefined !== this.game.levelWarpId ? level = this.game.world.getLevel(this.game.levelWarpId) : undefined === this.game.startDelta && (level = this.game.world.getInitialLevel());
        this.game.gameOver ? (context.fillStyle = "black",
        context.fillRect(0x0, 0x0, canvasWidth, canvasHeight),
        context.fillStyle = "white",
        context.font = "32px SmbWeb",
        context.textAlign = "center",
        context.fillText("GAME OVER", 0.5 * canvasWidth, 0.5 * canvasHeight)) : level && (context.fillStyle = "black",
        context.fillRect(0x0, 0x0, canvasWidth, canvasHeight),
        context.fillStyle = "white",
        context.font = "32px SmbWeb",
        context.textAlign = "center",
        context.fillText(level.name, 0.5 * canvasWidth, 0.5 * canvasHeight),
        0x0 <= this.game.startTimer && (context.font = "24px SmbWeb",
        context.textAlign = "center",
    ...
    Display.prototype.drawTouch = function() {
        if (this.game.touchMode) {
            ...
            this.game.thumbOrigin && (_0x5a1070.fillStyle = "rgba(0,0,0,0.5)",
            _0x5a1070.fillRect(this.game.thumbOrigin.x - 42.5, this.game.thumbOrigin.y - 42.5, 0x55, 0x55),
            _0x5a1070.fillStyle = "rgba(255,255,255,1.0)",
            _0x5a1070.fillRect(this.game.thumbPos.x - 32.5, this.game.thumbPos.y - 32.5, 0x41, 0x41));
    ...
    World.prototype.step = function() {
        for (var _0x1351b3 = 0x0; _0x1351b3 < this.levels.length; _0x1351b3++)
            this.levels[_0x1351b3].step();
    }
    ;
    ...
    function Level(game, data) {
        ...
        this.initial = data.initial;
        this.zones = [];
        for (var i = 0x0; i < data.zone.length; i++)
            this.zones.push(new Zone(game,this.id,data.zone[i]));
    }
    Level.prototype.step = function() {
        for (var _0x5d732a = 0x0; _0x5d732a < this.zones.length; _0x5d732a++)
            this.zones[_0x5d732a].step();
    }
    ;
    ...
    Zone.prototype.step = function() {
        ...
        for (var i = 0x0; i < this.sounds.length; i++)
            this.sounds[i].done() && this.sounds.splice(i--, 0x1);
    ...
    Zone.prototype.getEffects = function(displayList, textList) {
        for (var i = 0x0; i < this.effects.length; i++)
            this.effects[i].draw(displayList, textList);
    }
    ;
    "use strict";
    function Game(data) {
    ...
    Game.prototype.load = function(data) {
        ...
        var filterByTileset = function(dict, tileset) {
            return Object.keys(dict).filter(x=>dict[x].tilesets.length == 0 || dict[x].tilesets.includes(tileset)).reduce((res,key)=>(res[key] = dict[key],
            res), {});
        };
        ...
        for (var i = 0; i < this.world.levels.length; i++) {
            ...
            for (var j = 0; j < lvl.zones.length; j++) {
                ...
                for (var k = 0; k < zn.obj.length; k++) {
                    ...
                    var oid = obj.pos;
                    var pgen = [oid];
                    for (var l = 0; l < obj.param.length; l++) {
                        pgen.push(obj.param[l]);
                    }
                    if (zn.maxOid === undefined || oid > zn.maxOid)
                        zn.maxOid = oid;
    ...
    Game.prototype.getGameTimer = function(compact) {
        ...
        if (this.startDelta === undefined)
            return compact ? "00:00" : "00:00:000";
        var now = util.time.now() - this.poleTimes;
        var diff = now - this.startDelta;
    ...
    Game.prototype.doNET010 = function(n) {
        ...
        if (this.team) {
            ...
            if (playerInfo && playerInfo.id !== this.pid && playerInfo.team === this.team) {
                ...
                if (ghost)
                    ghost.name = playerInfo.displayName;
            }
        }
    }
    ;
    Game.prototype.doNET011 = function(n) {
        n.pid !== this.pid && ((n = this.getGhost(n.pid)) && n.kill(),
    ...
    Game.prototype.doTouch = function(lastInput) {
        ...
        for (var _0x3308c9, _0x174be8 = 0x0; _0x174be8 < _0x258db7.touch.pos.length; _0x174be8++) {
            ...
            if (this.thumbId === _0x182f56.id)
                _0x3308c9 = _0x182f56,
                this.thumbId = _0x182f56.id,
                this.thumbPos = _0x182f56;
            else
        ...
        for (_0x174be8 = 0x0; _0x174be8 < lastInput.touch.length; _0x174be8++) {
            ...
            _0x258db7 = false;
            for (_0x174be8 = 0x0; _0x174be8 < triggers.length; _0x174be8++)
                if (_0x287903 = triggers[_0x174be8],
                squar.inside(_0x182f56, _0x287903.pos, _0x287903.dim)) {
                    _0x258db7 = true;
                    _0x287903.click && _0x287903.click();
                    break;
                }
            _0x3308c9 || _0x258db7 || (_0x3308c9 = _0x182f56,
            this.thumbId = _0x182f56.id,
            this.thumbPos = this.thumbOrigin = _0x182f56);
        }
        var _0x36041a;
        if (_0x3308c9) {
            ...
            this.thumbPos = this.thumbOrigin = this.thumbId = undefined;
        _0x330893 && _0x3d0185 ? (_0x3d0185 = [0x0, 0x0],
        0.33 < _0x36041a.x && _0x3d0185[0x0]++,
        -0.33 > _0x36041a.x && _0x3d0185[0x0]--,
        0.33 < _0x36041a.y && _0x3d0185[0x1]--,
        -0.33 > _0x36041a.y && _0x3d0185[0x1]++,
        _0x330893.input(_0x3d0185, touchAPressed, this.touchRun ? !touchBPressed : touchBPressed)) : _0x330893 && _0x330893.input([0x0, 0x0], touchAPressed, this.touchRun ? !touchBPressed : touchBPressed);
    }
    ;
                ...
                if (0x0 === mouse.btn) {
                    ...
                    for (var icon of ingameGuiButtons) {
                        if (!icon.padMode || this.input.pad.connected()) {
                            off += HudButtonOffset;
                            if (icon.click && squar.inside(mouse.pos, vec2.make(canvasWidth - (off), 0x28), vec2.make(0x18, 0x18)))
                                icon.click()
                        }
                    }
                }
    ...
    Game.prototype.doStep = function() {
        ...
        player && !player.dead && !this.pauseCamera && this.display.camera.position(vec2.make(player.pos.x, 0.5 * zone.dimensions().y));
        this.world.step();
    ...
    Game.prototype.createObject = function(id, level, zoneId, pos, extraArgs) {
        ...
        for (var i = 0x0; i < extraArgs.length; i++)
    ...
    Game.prototype.getObject = function(level, zone, oid) {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (undefined !== obj.oid && obj.level === level && obj.zone === zone && obj.oid === oid)
                return obj;
        }
    }
    ;
    Game.prototype.getFlag = function(level, zone) {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (obj.level === level && obj.zone === zone && obj instanceof FlagpoleObject)
                return obj;
        }
    }
    ;
    Game.prototype.getAxe = function(level, zone) {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (obj.level === level && obj.zone === zone && obj instanceof AxeObject)
                return obj;
        }
    }
    ;
    Game.prototype.getText = function(_0x684bab, _0x1988a8, _0x26b734) {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (obj && obj.level === _0x684bab && obj.zone === _0x1988a8 && obj instanceof TextObject && obj.text === _0x26b734.toString())
                return obj;
        }
    }
    ;
    ...
    Game.prototype.getGhost = function(pid) {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (undefined !== obj.pid && obj.pid === pid)
                return obj;
        }
    }
    ;
    Game.prototype.getPlayer = function() {
        for (var i = 0; i < this.objects.length; i++) {
            var obj = this.objects[i];
            if (undefined !== obj.pid && obj.pid === this.pid)
                return obj;
        }
    }
    ;
        ...
        try {
            if (this.ready && undefined !== this.startDelta) {
                ...
                if (frm > this.frame) {
                    ...
                    for (this.doDetermine(); frm > this.frame; )
                        this.doStep();
                    this.doPush();
                    this.delta = time;
                }
    ...
    App.prototype.join = function(name, team, priv, skin, gm) {
        ...
        this.net.connect([Network.CONNECTTYPE.GUEST, name, team, priv, skin, gm]));
    }
    ;
    App.prototype.login = function(username, pw) {
        this.menu.load.show(),
        this.net.connect([Network.CONNECTTYPE.LOGIN, username, pw]);
    }
    ;
    ...
    App.prototype.register = function(username, pw, captcha) {
        this.menu.load.show(),
        this.net.connect([Network.CONNECTTYPE.REGISTER, username, pw, captcha]);
    }
    ;
    App.prototype.resumeSession = function(session) {
        this.menu.load.show(),
        this.net.connect([Network.CONNECTTYPE.RESUME, session]);
    }
    ;
